...
<template>
  ...
  <footer class="flex flex-col-reverse items-center justify-center sm:flex-row gap-4 p-4">
    ...
    <div class="flex gap-4">
      <NuxtLink v-for="items in links" :to="items.to">
        {{ items.label }}
      </NuxtLink>
    </div>
    ...
    <div class="flex gap-2">
      <UButton
        icon="i-simple-icons-x" color="neutral" variant="ghost" to="https://x.com/thee_hamza001"
        target="_blank" aria-label="X"
      />
      <UButton
        icon="i-simple-icons-github" color="neutral" variant="ghost"
